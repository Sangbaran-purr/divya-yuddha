...
const ASURA_DECK_DEF = [
  ...
  // ---- WAVE 1 (batch 19 — deferred heroes) ----
  { id:'mahishi',  n:'Mahishi',          sub:'The Buffalo Queen',    t:'hero', p:6, r:'L', wave:1, txt:'ROUND END (once per game): become a copy of the strongest friendly Unit’s power THIS ROUND ONLY.' },   // R64 P7→P6; R66 once-per-game gain-only; R72 (design round 2): the copy is THIS ROUND ONLY — reverts to her pre-copy power at the board clear (the cross-round CARRY was the ability; absolute win-when-played was flat 69.6→71.2 through both prior nerfs). h.mahishiPreCopy stash. ART GATE (3rd change): Asuras_Hero_Mahishi_P6_rLegendary.
];
